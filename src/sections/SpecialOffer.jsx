...
const SpecialOffer = () => {
  return (
    <section
      className="flex items-center gap-10 justify-wrap max-xl:flex-col-reverse max-container"
    >
      <div
        className="flex-1"
      >
      ...
      >
        ...
        >
          ...
          <Button label="Learn More" backgroundColor="bg-white" bordorColor="border-slate-gray" textColor="text-slate-gray" />
        </div>
      </div>
    </section>
  )
